...
prompt = f"""
you are a professional gmail writting assistant.
...
"""
  ...
  url = (
    ...
    f"vlbeta/models/{MODELS}:generatecontent"
    }
...
if not subject or not body:
  raise RuntimeError("Gemini returened an invalid email formate.")
